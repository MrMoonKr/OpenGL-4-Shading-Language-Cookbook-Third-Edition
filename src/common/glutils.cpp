...
void GLAPIENTRY debugCallback( GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar *msg,
                             const void *param )
{
...
int checkForOpenGLError( const char* sourceFile, int sourceLine )
{
    //
